...
- **Description** — some text describing in more words what the challenge is
  about. This field supports [Markdown](/en-US/documentation/markdown/) and
...
are the ones your [teams](/en-US/documentation/teams/) have had approved: any
...
- **I want to provide an Overpass query** — Overpass QL that generates the
  ...
  Challenges](/en-US/documentation/using-overpass-to-create-challenges/) for
...
- **I want to upload a GeoJSON file** — a GeoJSON file from your computer.
  ...
  GeoJSON](/en-US/documentation/line-by-line-geojson/) are both supported.
- **I have a URL to the GeoJSON data** — a URL pointing directly at the raw
  ...
  Gists](/en-US/documentation/gists-for-remote-geojson/).

You can also record the [date the data was
sourced](/en-US/documentation/defining-task-sourced-date/) here.
...
> [Rebuild Tasks](/en-US/documentation/rebuilding-challenge-tasks/).
...
- **Configure prioritization** to decide which tasks get served first — see
  [Prioritizing Tasks](/en-US/documentation/task-priority-rules/)
