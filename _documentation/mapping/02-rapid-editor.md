...
The bar above the editor adds a few MapRoulette-specific controls:
...
- **Focus** / **Show All** — dim everything except the task features, or bring
  the rest of the map back
- **Close editor** — return to the task map. If you have unsaved edits, the
  count is shown next to the button and you'll be asked to confirm
...
> [Tag Fix challenges](/documentation/tag-fix-challenges/) are not edited
