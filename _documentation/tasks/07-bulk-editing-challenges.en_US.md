...
| **Tag**           | Applies the [MR Tags](/en-US/documentation/using-maproulette-tags/) you enter to every selected task |
...
[rebuild tasks](/en-US/documentation/rebuilding-challenge-tasks/), enable or
disable, and delete.
